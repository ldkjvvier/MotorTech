					...
					<div className="relative flex h-16 items-center justify-between">
						...
						<div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
							<button
								type="button"
								onClick={handleClick}
								className="relative rounded-full p-1 dark:text-gray-200 text-black dark:hover:text-white focus:outline-none focus:ring-white ml-3 bg-gray-100 dark:bg-gray-700"
							>
								<span className="absolute -inset-1.5"></span>
								<span className="sr-only">View darkmode</span>
